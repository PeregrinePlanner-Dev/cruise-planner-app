...
DESTINATION_REGION_MAP = {
    ...
    'Northern Europe': ['canary_islands'],
...
def build_system_blocks(profile=None):
    ...
    phase_3_reached = bool(atmosphere or cruise_exp or onboard or has_destination)
    ...
    blocks = [
        ...
        {"type": "text", "text": BLOCK_LINE_PRESENCE},
        {"type": "text", "text": BLOCK_FARE_INCLUSIONS, "cache_control": {"type": "ephemeral"}},
    ]
    ...
    if phase_3_reached:
        blocks.append({"type": "text", "text": BLOCK_ONBOARD_SPEND})
        blocks.append({"type": "text", "text": BLOCK_CABIN_LIFESTYLE, "cache_control": {"type": "ephemeral"}})
    ...
    if profile.get("handoff_generated"):
        handoff_parts.append(
          ...
          and (profile.get("travel_dates") or profile.get("travel_year"))
...
EMAIL_COLLECTION_TEXT = (
    ...
    "We keep everything secure and private, and won't use it for anything else. "
...
def render_client_page(rec):
    ...
    return (
        ...
        "    <ol class='cl'>\n"
        "      <li>Your advisor will reach out within 1&ndash;2 business days with cruise options that match your profile.</li>\n"
...
def handoff_generate():
    ...
    try:
        ...
        # Send advisor handoff email
        try:
            send_handoff_email(session_id, profile, shortlist, eliminated, advisor_alerts, portrait, handoff_id)
        except Exception as e:
